...
export default function Header() {
  return (
    <header className="bg-gradient-to-r from-purple-600 to-indigo-600 font-serif pb-5">
      <nav>
        <div className="flex justify-between items-center w-[80%] mx-auto py-8">
          <div>
            <img className="w-40 h-12 rounded-2xl " src={logo} alt="Logo" />
          </div>
          ...
          <div className="flex items-center gap-8 text-white font-bold">
            ...
            <Link
              to="/comingsoon"
              target="_blank"
              className="px-4 py-3 border border-white rounded-2xl"
            >
              Get the App
            </Link>
            <Link
              to="/comingsoon"
              target="_blank"
              className="px-4 py-3 border border-black rounded-2xl bg-black text-white"
            >
              Sign in
            </Link>
          </div>
      ...
      <div className="relative">
        <img
          className="max-h-112.5 max-w-62.5 absolute left-0 top-0"
          src="https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto/portal/testing/seo-home/Veggies_new.png"
        />

        <div className="max-w-[60%] flex flex-col items-center gap-6 mx-auto pt-16 pb-8">
          <div className="text-5xl text-white leading-14 pl-3 text-center font-bold">
          ...
          <div className="flex gap-4 justify-center w-full">
            <input
              ...
              className="bg-white w-[40%] rounded-2xl px-4 h-12"
            />
            <input
              type="text"
              placeholder="Search for restaurant, item or more"
              className="bg-white w-[60%] rounded-2xl px-4 h-12 font-bold"
            />
          </div>
        </div>

        <img
          className="max-h-112.5 max-w-62.5 absolute right-0 top-0"
